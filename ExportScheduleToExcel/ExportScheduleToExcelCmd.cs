...
namespace AlphaBIM
{
    ...
    public class ExportScheduleToExcelCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            {
                tranGroup.Start("ExportScheduleToExcel");

                ExportScheduleToExcelViewModel viewModel = new ExportScheduleToExcelViewModel(uidoc);
                ExportScheduleToExcelWindow window = new ExportScheduleToExcelWindow(viewModel);
